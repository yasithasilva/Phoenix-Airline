<%-- 
    Document   : userm
    Created on : Oct 6, 2022, 1:16:47 AM
...
<html>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a href="userm.jsp" class="active">User Menu</a></li>
  ...
  <div class="second-page-heading">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2>Get Your User details via ID</h2>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row">
               <div class="table2">
                <table>
                  ...
                  <tr>
                    <td>
                      <label for="Name" class="form-label">Ticket ID</label>
              ...
              <center>
                <div class="border-button"><a href="#">Update</a>
                  <a href="#">Delete</a>
                  <a href="#">Cancel</a></div>
              </center>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <br>Design: <a href="m" target="_blank" title="s">NSBM Green University</a></p>
        </div>
      </div>
    </div>
  </footer>
