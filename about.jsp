      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="content">
            ...
            <h2>Welcome Phoenix Airlines</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt uttersi labore et dolore magna aliqua is ipsum suspendisse ultrices gravida</p>
            <div class="main-button">
              <a href="checkflight.jsp">Discover More</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="item">
              <div class="thumb">
                ...
                <div class="text">
                  ...
                  <div class="main-button">
                    <a href="ticketbook.jsp">Make a Reservation</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="main-button">
            <a href="ticketbook.jsp">Discover More</a>
          </div>
        </div>
      </div>
    </div>
