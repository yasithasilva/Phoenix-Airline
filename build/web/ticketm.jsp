<%-- 
    Document   : ticketm
    Created on : Oct 6, 2022, 1:15:53 AM
...
<html>
  ...
  <div class="second-page-heading">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2>Get Your Ticket details via ID</h2>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row">
               <div class="table2">
                <table>
                    ...
                    <tr>
                      <td>
                        <label for="Name" class="form-label">passenger ID</label>
                  ...
                  <tr>
                    <td>
                      <label for="Name" class="form-label">Seat Number</label>
                      <input class="box" type="text" name="passwordconfirm" class="name"  autocomplete="on" required>
                  </td>
                  </tr>
              ...
              <center>
                <div class="border-button"><a href="about.jsp">Update</a>
